package typeclasses._03c_my_printable_oneimport.user

import java.util.Date

import typeclasses._03c_my_printable_oneimport.domain._

// This is the only (wildcard) import needed to use libPrintable
//
import typeclasses._03c_my_printable_oneimport.libPrintable._
